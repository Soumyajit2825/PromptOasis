...
const ideasByTopic = {
  app: [
    { idea: "Fitness Tracker application", description: "Create an application that allows users to track their fitness activities, set goals, monitor progress, and provide workout recommendations. Include features like GPS tracking, calorie counting, and integration with wearable devices." },
    ...
    { idea: "Travel Planner", description: "Develop an appliction that assists users in planning their trips, including features like destination suggestions, itinerary creation, flight and hotel bookings, and offline maps." },
...
webDev: [
    ...
    { idea: "Crowd funding Platform", description: "Develop a website that allows individuals or organizations to raise funds for their projects or causes, with options for donations, reward-based funding, and social sharing." },
...
robotics: [
    { idea: "Autonomous Line Following bot", description: "Design and build an autonomous robot capable of following a line on the ground without human intervention. The robot will be equipped with sensors and actuators that allow it to sense the line and adjust its movements accordingly to stay on the path." },
    { idea: "Firefighting bot", description: "Design a robot capable of detecting and extinguishing fires. Use infrared sensors to locate fires and actuators like a water pump to extinguish them." },
    { idea: "Autonomous Navigation bot", description: "Build a robot capable of autonomously navigating through a given environment, avoiding obstacles, and reaching a specific destination using sensors like ultrasonic, infrared, or lidar." },
    ...
    { idea: "Humanoid Robot", description: "Develop a humanoid robot that can mimic human movements and perform tasks like walking, grasping objects, or even dancing. Explore kinematics, dynamics, and control algorithms for human-like motion." },
    { idea: "Bot for Home Automation", description: "Construct a bot that can control various smart devices in a home environment, such as lights, thermostats, or security systems. Implement voice or gesture recognition for intuitive user interaction." },
    ...
    { idea: "Agricultural Bot", description: "Develop bot designed for agricultural applications, such as crop monitoring, planting, or harvesting. Incorporate sensors, computer vision, and autonomous navigation capabilities to optimize farming processes." },
  ...
  iot: [
    ...
    { idea: "Cloud-Based IoT Analytics", description: "Develop an analytics platform that processes and analyzes massive amounts of data generated by IoT devices to derive valuable insights and support decision-making"}, 
  ],
  cloud: [
    { idea: "File Sharing and Storage Platform", description: "Create a cloud storage and file-sharing platform similar to Dropbox or Google Drive. Allow users to upload, access, and share files securely over the internet"},
    { idea: "Collaboration Tools", description: "Develop cloud-based collaboration tools like real-time document editing, task management, and video conferencing to enhance team productivity and remote work"},
    { idea: "Machine Learning Platform", description: "Develop a cloud-based platform that allows users to train and deploy machine learning models without the need for extensive hardware resources"},
    { idea: "Virtual Classroom", description: " Create a cloud-based virtual classroom platform that facilitates online learning with features like video conferencing, interactive whiteboards, and content sharing"},
    { idea: "Sentiment Analysis", description: "Build a cloud-based sentiment analysis tool that analyzes text data from social media or customer reviews to gauge public opinion about products, services, or events"}, 
    { idea: "Music or Podcast Hosting Platform", description: "Develop a cloud-based platform that allows artists and podcasters to upload, host, and distribute their content to a global audience"}, 
    { idea: "Cloud-Based IoT Analytics", description: "Develop an analytics platform that processes and analyzes massive amounts of data generated by IoT devices to derive valuable insights and support decision-making"}, 
  ],
  ],
};
